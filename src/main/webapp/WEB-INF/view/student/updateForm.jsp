...
<div class="container">
	...
	<div>
			<h3>Mise à jour d'un Etudiant</h3>
	</div>
	<div>
		...
		<f:form action="${pageContext.request.contextPath}/student/updatePerson"
			...
			<div class="row">
				<div class="col">
				<!-- f:input: jstl tags, path help to bind data into the from from the personModel att and place it into the form -->
					<label>CIN</label>
